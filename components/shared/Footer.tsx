    ...
    <footer className="w-full px-6  md:px-10 xl:mx-auto xl:max-w-[1600px] xl:px-16">
      <div className=" flex flex-col justify-between border-t border-slate-400 pt-4 text-xs  md:text-sm lg:py-8">
        ...
        <div className="gap-x-2 md:flex md:flex-row md:justify-between ">
          <div className="mb-6">
            <span className="text-lg uppercase ">Services </span>
          ...
          <div className="mb-6">
            <span className="text-lg  uppercase ">Contact </span>
            <div className="mt-3 flex flex-col gap-y-2 text-sm">
          ...
          <div className="mb-6">
            ...
            <div className="mt-3 flex flex-col gap-y-2 text-sm">
              <Link href="/faq" aria-label="Aller à la page de la foire aux questions" className="xl:hover:text-primary">
                Foire aux questions
              </Link>
              <Link href="/mentions" aria-label="Aller à la page des mentions légales" className="xl:hover:text-primary">
                Mentions légales
              </Link>
              <Link href="/cgv" aria-label="Aller à la page des conditions générales de ventes" className="xl:hover:text-primary">
