...
export default async function SignIn() {
  ...
  return (
    <main className="flex h-screen flex-row items-center justify-center">
      <div className="mx-4 flex flex-col items-center gap-y-4 rounded-xl bg-slate-900 p-8 md:p-12 lg:p-20">
        ...
        <p className="w-[340px] text-center">
          Entrez votre email administrateur et nous vous enverrons un code de
          connexion.
        </p>
        <PasswordlessEmail />
      </div>
